...
const architect: ArchitectApi = {
  ...
  worktreeSettings: () => invoke('architect:worktree-settings'),
  saveWorktreeSettings: (settings) => invoke('architect:worktree-settings-save', settings),
  pickFolder: () => invoke('architect:pick-folder'),
